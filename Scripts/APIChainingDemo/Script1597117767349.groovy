...
response1 = WS.sendRequest(findTestObject('RESTWebService/ListUsers'))
...
//
//WS.sendRequestAndVerify(findTestObject('RESTWebService/UpdateUser'))
WS.sendRequestAndVerify(findTestObject('RESTWebService/UpdateUser', [('userName') : value]))
